...
from explainer.yara_rule_explainer import YaraRuleExplainer
...
class YaraReportGenerator:
    ...
    def add_yara_matches(self, matches:  list):
        ...
        if self.yara_ai_explainer:
            ...
            self.report_data["yara_ai_explainer"] = "YARA matches' AI explaination not enabled for this report"
